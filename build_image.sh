...
AUDIO_FW=$IMAGEDIR/dailybuild/audio-fw/hercules
ERR=0
...
DTBOIMG=$KERNEL_BOOT_DIR/dts/realtek/rtd139x/dtbo/rtd-139x.dtboimg
...
#[ "$ANDROID_PRODUCT"        = "" ] && ANDROID_PRODUCT=hercules32
#[ "$SHRINK_GOLDEN_IMG"      = "" ] && SHRINK_GOLDEN_IMG=true
#[ "$CHIP_ID"                = "" ] && CHIP_ID=hercules
...
make image CHIP_ID=hercules PACKAGES=package5 install_dtb=0 GPT=1 PART_RESIZE=1 layout_type=emmc layout_size=8gb layout_use_emmc_swap=false install_factory=1 AUDIOADDR=0x0f900000 ANDROID_PRODUCT=hercules32 install_avfile_count=1 install_bootloader=0 TEE_FW=n offline_gen=n chip_rev=2 SHRINK_GOLDEN_IMG=true MANIFEST_BRANCH=origin/android-9.0.0-b/trunk-9.0 TARGET_CHIP_ARCH=arm32 enable_ab_system=n enable_dm_verity=n vmx=n ANDROID_BRANCH='android-9'

#ANDROID_BRANCH='android-9' android_branch=android-9 CHIP_ID=hercules PACKAGES=package5 install_dtb=0 GPT=1 PART_RESIZE=1 layout_type=emmc layout_size=8gb layout_use_emmc_swap=false install_factory=0 AUDIOADDR=0x0f900000 ANDROID_PRODUCT=hercules32tv install_avfile_count=1 install_bootloader=0 TEE_FW=n offline_gen=n chip_rev=1 SHRINK_GOLDEN_IMG=true MANIFEST_BRANCH=origin/android-9.0.0-b/p-tv-release/hercules-b/Hercules-ATV-Cert TARGET_CHIP_ARCH=arm32 enable_ab_system=n enable_dm_verity=n vmx=n
...
clean_all()
{
  ...
  echo "delete $PACKAGE_DIR/vendor"
