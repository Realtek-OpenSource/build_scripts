...
PRODUCT_DEVICE_PATH=android/out/target/product/thor32
...
function android_config()
{
    ...
    list_add ANDROID_PRODUCT_LIST rtk_thor
    list_add ANDROID_PRODUCT_LIST rtk_hank
    ...
    list_add ANDROID_PRODUCT_LIST hank32
    list_add ANDROID_PRODUCT_LIST hank32tv
    list_add ANDROID_PRODUCT_LIST hank64
    list_add ANDROID_PRODUCT_LIST hank64tv
...
function android_init()
{
    ...
    repo init -u $GERRIT_MANIFEST -b master -m android_v1.3.xml $REPO_PARA
    popd > /dev/null
#    gms_init    || return 1
    return 0
}
...
function android_export_environmental_variables()
{
	...
	store_list=
        ...
        list_add store_list ENABLE_VMX_HARDENING
...
function android_auto_clear()
{
    ...
    config_get_true ANDROID_CLEAR_VENDOR    && list_add clear_list `android_vendor_dir_get`
